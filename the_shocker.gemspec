...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependecy 'rake', '~> 11.2.2'

  spec.required_ruby_version = '>= 2.2.0'
  spec.add_runtime_dependency 'railties', '~> 4.2.6'
  spec.add_runtime_dependency 'pry', '~> 0.10.3'
  spec.add_runtime_dependency 'pry-rails', '~> 0.3.4'
  spec.add_runtime_dependency 'pry-doc', '~> 0.8.0'
  spec.add_runtime_dependency 'pry-stack_explorer', '~> 0.4.9.2'
  spec.add_runtime_dependency 'pry-byebug', '~> 3.4.0'
  spec.add_runtime_dependency 'pry-coolline', '~> 0.2.5'
  spec.add_runtime_dependency 'pry-rescue', '~> 1.4.4'
  spec.add_runtime_dependency 'pry-clipboard', '~> 0.1.1'
